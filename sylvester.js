...
Vector.prototype = {
    ...
    indexOf: function(x) {
        var a = null , n = this.elements.length, k = n, i;
        do {
            i = k - n;
...
Vector.Random = function(n) {
    ...
    do {
        a.push(Math.random())
    } while (--n);return Vector.create(a)
}
;
...
Matrix.prototype = {
    ...
    col: function(j) {
        ...
        var a = [], n = this.elements.length, k = n, i;
        do {
            i = k - n;
    ...
    eql: function(a) {
        ...
        var b = this.elements.length, ki = b, i, nj, kj = this.elements[0].length, j;
        do {
            i = ki - b;
            nj = kj;
            do {
    ...
    map: function(a) {
        var b = [], ni = this.elements.length, ki = ni, i, nj, kj = this.elements[0].length, j;
        do {
            i = ki - ni;
            nj = kj;
            b[i] = [];
        ...
        } while (--ni);return Matrix.create(b)
    },
    ...
    multiply: function(a) {
        ...
        } while (--d);var M = Matrix.create(elements);
        return b ? M.col(1) : M
    },
    x: function(a) {
    ...
    minor: function(a, b, c, d) {
        ...
        } while (--ni);return Matrix.create(e)
    },
    transpose: function() {
        var a = this.elements.length
          , cols = this.elements[0].length;
        var b = [], ni = cols, i, nj, j;
        do {
            i = cols - ni;
            b[i] = [];
            nj = a;
    ...
    indexOf: function(x) {
        var a = null , ni = this.elements.length, ki = ni, i, nj, kj = this.elements[0].length, j;
        do {
            i = ki - ni;
            nj = kj;
            do {
    ...
    determinant: function() {
        ...
        var a = M.elements[0][0], n = M.elements.length - 1, k = n, i;
        do {
            i = k - n + 1;
            a = a * M.elements[i][i]
        } while (--n);return a
    ...
    trace: function() {
        ...
        var a = this.elements[0][0], n = this.elements.length - 1, k = n, i;
        do {
            i = k - n + 1;
            a += this.elements[i][i]
        } while (--n);return a
    ...
    rank: function() {
        var M = this.toRightTriangular()
          , rank = 0;
        var a = this.elements.length, ki = a, i, nj, kj = this.elements[0].length, j;
        do {
            i = ki - a;
            nj = kj;
            do {
    ...
    augment: function(a) {
        ...
        var b = T.elements.length, ki = b, i, nj, kj = M[0].length, j;
        if (b != M.length) {
            return null 
        }
        do {
    ...
    inverse: function() {
        ...
        do {
            ...
            for (j = 0; j < i; j++) {
                ...
                } while (--b);M.elements[j] = els
            }
        } while (--a);return Matrix.create(c)
    },
    inv: function() {
        return this.inverse()
    },
...
Matrix.I = function(n) {
    ...
    } while (--n);return Matrix.create(a)
}
;
Matrix.Diagonal = function(a) {
    var n = a.length, k = n, i;
    var M = Matrix.I(n);
    do {
        i = k - n;
        M.elements[i][i] = a[i]
...
Matrix.Zero = function(n, m) {
    ...
    } while (--ni);return Matrix.create(a)
}
;
function Line() {}
Line.prototype = {
